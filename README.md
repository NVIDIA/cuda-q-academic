...
The folder titled `qaoa-for-max-cut` contains a self-contained version of the Divide-and-Conquer QAOA for Max Cut module suitable for self-guided learning. The folder titled IEEE_Quantum_Week_2024, contains the version of Divide-and-Conquer QAOA for Max Cut module suitable for live classroom instruction.
