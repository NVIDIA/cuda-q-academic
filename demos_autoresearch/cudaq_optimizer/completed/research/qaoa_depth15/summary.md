# qaoa_depth15 observe-budgeted optimizer autoresearch

- Recorded rounds: 20
- Valid energy results: 20
- Accepted-energy converged rounds: 16
- Observe-capped, non-converged rounds: 4
- Lowest observed energy: -5.71419103486 (round 19)

## Round results

| Round | Optimizer | Lowest energy | Elapsed s | Calls | Converged | New leader | Status |
| ---: | --- | ---: | ---: | ---: | --- | --- | --- |
| 1 | COBYLA rhobeg=1.0 baseline | -5.446702633 | 4.674 | 74 | yes | yes | converged |
| 2 | SPSA-Adam 120-call search + COBYLA rhobeg=0.35 | -5.498239483 | 10.834 | 173 | yes | yes | converged |
| 3 | SPSA-Adam 180-call search + COBYLA rhobeg=0.35 | -5.617366591 | 16.401 | 259 | yes | yes | converged |
| 4 | Orthogonal 12D search 135 calls + COBYLA rhobeg=0.35 | -5.586248112 | 13.481 | 216 | yes | no | converged |
| 5 | SPSA-Adam 195-call search + COBYLA rhobeg=0.35 | -5.623769773 | 19.101 | 296 | yes | yes | converged |
| 6 | Five-mode layer search 120 calls + COBYLA rhobeg=0.35 | -5.629584325 | 10.295 | 165 | yes | yes | converged |
| 7 | Five-mode layer search 160 calls + COBYLA rhobeg=0.35 | -5.628303000 | 13.794 | 211 | yes | no | converged |
| 8 | Layer-pair quadratic models 135 calls + COBYLA rhobeg=0.35 | -5.528437209 | 12.285 | 188 | yes | no | converged |
| 9 | Five-mode layer search 120 calls + COBYLA rhobeg=0.20 | -5.644520195 | 10.951 | 170 | yes | yes | converged |
| 10 | 10D mode Powell 120 calls + COBYLA rhobeg=0.20 | -5.678151759 | 10.404 | 165 | yes | yes | converged |
| 11 | 10D mode Powell 160 calls + COBYLA rhobeg=0.20 | -5.683300345 | 12.748 | 199 | yes | yes | converged |
| 12 | 10D full-covariance ES 156 calls + COBYLA rhobeg=0.20 | -5.528729557 | 12.922 | 199 | yes | no | converged |
| 13 | 10D mode Powell 180 calls + COBYLA rhobeg=0.20 | -5.684350392 | 14.190 | 219 | yes | yes | converged |
| 14 | 10D Powell 180 + modes 5-6 residual 40 + COBYLA 0.20 | -5.687775017 | 16.875 | 259 | yes | yes | converged |
| 15 | 10D Powell 180 + modes 5-6 residual 48 + COBYLA 0.20 | -5.712105851 | 19.978 | 300 | no | yes | call_cap |
| 16 | Powell180 + residual48 + full diagonal-Newton line search | -5.700662544 | 19.382 | 300 | no | no | call_cap |
| 17 | 10D Powell 180 + modes 5-6 residual 48 + COBYLA 0.12 | -5.693028112 | 17.124 | 268 | yes | no | converged |
| 18 | Joint 14D adaptive Nelder-Mead 228 + COBYLA 0.20 | -5.682984405 | 15.447 | 267 | yes | no | converged |
| 19 | 10D Powell 180 + modes 5-6 residual 48 + COBYLA 0.25 | -5.714191035 | 17.963 | 300 | no | yes | call_cap |
| 20 | Powell180 + residual48 + bounded 14D L-BFGS-B | -5.695457548 | 17.767 | 300 | no | no | call_cap |

## Winning implementation

Round 19 (`10D Powell 180 + modes 5-6 residual 48 + COBYLA 0.25`) won under the energy and close-tie rules with energy -5.71419103486, in 17.963 seconds using 300 counted circuit evaluations. Accepted-energy convergence: no.

Optimizer source SHA-256: `d01107b0d45315612f88d30850fb46645ca40176dc7551bd9f2b962a192261a8`.
