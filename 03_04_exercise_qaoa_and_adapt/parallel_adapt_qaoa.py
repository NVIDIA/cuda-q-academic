"""Baseline CUDA-Q ADAPT-QAOA implementation for MaxCut.
...
PROBLEM_SOURCE = "qedc"  # "manual" or "qedc"
...
QEDC_INSTANCE = DEFAULT_QEDC_INSTANCE
...
if __name__ == "__main__":
    ...
    print(f"Final energy: {summary['final_energy']}")
    print(f"Iterations: {len(summary['layers'])}")
